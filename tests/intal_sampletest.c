...
int main(int argc, char const *argv[]) {
	...
	result1 = intal_add("0", a[1]);
	if(!result1) {
		printf("Test intal_add FAILED.\n");
	} else {
		if(0 == strcmp(result1, a[1])) {
			printf("Test intal_add PASSED\n");
		} else {
			printf("Test intal_add FAILED.\nYour answer: %s\nExpected answer: %s\n", result1, a[1]);
		}
	...
	if(!result1) {
		printf("Test intal_diff 0-0 FAILED.\n");
	} else {
		if(0 == strcmp(result1, "0")) {
			printf("Test intal_diff 0-0 PASSED\n");
		} else {
			printf("Test intal_diff FAILED.\nYour answer: %s\nExpected answer: %s\n", result1, "0");
		}
		free(result1);
	...
	result1 = intal_multiply("5", "0");
	if(!result1) {
		printf("Test intal_multiply FAILED.\n");
	} else {
		if(0 == strcmp(result1, "0")) {
			printf("Test intal_multiply with 0 PASSED\n");
		} else {
			printf("Test intal_multiply with 0 FAILED.\nYour answer: %s\nExpected answer: %s\n", result1, "0");
		}
		free(result1);
	}*/
	...
	result1 = intal_mod("8997866588998", "33456");
	if(!result1) {
		printf("Test intal_mod FAILED.\n");
	} else {
		if(0 == strcmp(result1, "12598")) {
			printf("Test intal_mod PASSED with values 8997866588998 and 33456, answer is %s\n", result1);
		} else {
			printf("Test intal_mod FAILED.\nYour answer: %s\nExpected answer: %s\n", result1, "12598");
		}
		free(result1);
	...
	result1 = intal_gcd("0", "3");
	if(!result1) {
		printf("Test intal_gcd FAILED.\n");
	} else {
		if(0 == strcmp(result1, "3")) {
			printf("Test intal_gcd of 0,3 PASSED\n");
		} else {
			printf("Test intal_gcd of 0,3 FAILED.\nYour answer: %s\nExpected answer: %s\n", result1, "3");
		}
		free(result1);
	}
	...
	if(!result1) {
		...
		if(0 == strcmp(result1, "2")) {
			printf("Test intal_fibonacci(3) PASSED\n");
		} else {
			printf("Test intal_fibonacci FAILED.\nYour answer: %s\nExpected answer: %s\n", result1, "2");
		}
		free(result1);
	...
	if(!result1) {
		...
		if(0 == strcmp(result1, "222232244629420445529739893461909967206666939096499764990979600")) {
			printf("Test intal_fibonacci(300) PASSED\n");
		} else {
			printf("Test intal_fibonacci FAILED.\nYour answer: %s\nExpected answer: %s\n", result1, "2");
		}
		free(result1);
	...
	if(!result1) {
		...
		if(0 == strcmp(result1, "43466557686937456435688527675040625802564660517371780402481729089536555417949051890403879840079255169295922593080322634775209689623239873322471161642996440906533187938298969649928516003704476137795166849228875")) {
			printf("Test intal_fibonacci(1000) PASSED\n");
		} else {
	...
	if(!result1) {
		...
		if(0 == strcmp(result1, "")) {
			printf("Test intal_fibonacci(1450) PASSED\n");
		} else {
			printf("Test intal_fibonacci FAILED.\nYour answer: %s\nExpected answer: %s\n", result1, "43466557686937456435688527675040625802564660517371780402481729089536555417949051890403879840079255169295922593080322634775209689623239873322471161642996440906533187938298969649928516003704476137795166849228875");
		}
		free(result1);
	...
	result1 = intal_bincoeff(200, 135);
	if(!result1) {
		printf("Test intal_bincoeff FAILED.\n");
	} else {
		if(0 == strcmp(result1, "355410124430498052252434369613867238863579093582797880")) {
			printf("Test intal_bincoeff PASSED\n");
		} else {
			printf("Test intal_bincoeff FAILED.\nYour answer: %s\nExpected answer: %s\n", result1, "45");
		}
	...
	for(int i=0; i<10; ++i)
		printf("%s\n", a[i]);
	index1 = intal_binsearch(a, 10, "1234512345123451234512345");
	if(4 == index1) {
	...
	//char* coins[] = {"5", "22", "26", "15", "4", "3","11"};
	char* coins[] = {"10", "2", "4", "6", "3", "9", "5"};
	result1 = coin_row_problem(coins,7);
	if(0 == strcmp("25", result1)) {
